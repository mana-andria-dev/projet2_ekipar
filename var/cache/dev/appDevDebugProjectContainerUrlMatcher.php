...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if ($pathinfo === '/user/home') {
            return array (  '_controller' => 'AppBundle\\Controller\\DefaultController::userAction',  '_route' => 'homepage_user',);
        }

        // homepage_admin
        if ($pathinfo === '/admin/home') {
            return array (  '_controller' => 'AppBundle\\Controller\\DefaultController::adminAction',  '_route' => 'homepage_admin',);
        }
